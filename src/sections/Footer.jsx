    ...
    <footer className="max-container">
      <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col">
        <div className="flex flex-col items-start">
          ...
          <p className="mt-6 text-base leading-7 font-montserrat text-white-400 sm:max-w-sm mb-6">
      ...
      <div className='flex justify-between text-white-400 mt-4 max-sm:flex-col max-sm:items-center'>
        ...
        <p className='font-montserrat cursor-pointer mb-10'>Terms & Conditions</p>
      </div>
    </footer>
  )
}
